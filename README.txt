...
* categoria
* producto
Se debe ejecutar el archivo API\deploy.php
...
* GET -> Trae categorias:
http://localhost/API/api/categoria/?pag=1&reg=3
...
* GET -> Trae productos:
http://localhost/API/api/producto/?pag=1&reg=3
http://localhost/API/api/producto/?pag=1&sku=111aaa
